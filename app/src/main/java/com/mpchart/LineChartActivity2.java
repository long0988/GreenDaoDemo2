...
public class LineChartActivity2 extends BaseActivity implements SeekBar.OnSeekBarChangeListener,
...
//            }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        setData(mSeekBarX.getProgress() + 1, mSeekBarY.getProgress()+1);
