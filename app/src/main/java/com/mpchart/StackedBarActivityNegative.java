...
public class StackedBarActivityNegative extends BaseActivity implements
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        yValues.add(new BarEntry(45, new float[]{ -19, 20 }, getResources().getDrawable(R.mipmap.star)));
