...
public class CompletedView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.TasksCompletedView_myradius, 80);
        ...
        isShowText=typeArray.getBoolean(R.styleable.TasksCompletedView_isShowText,true);
        String text=typeArray.getString(R.styleable.TasksCompletedView_textType);
        if(text!=null){
            textType=text;
        }
