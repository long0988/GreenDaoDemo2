...
public class LinearDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public LinearDecoration(Context context, int orientation,int id) {
        this(context, orientation, 1,id);
    }
     ...
     */
    public LinearDecoration(Context context, int orientation, int dividerHeight,int id) {
        ...
        mDividerColor = ContextCompat.getColor(context, id);
